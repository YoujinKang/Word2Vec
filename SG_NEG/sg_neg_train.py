from sg_neg import ModelSG_Neg
import argparse
...
parser.add_argument('--model', type=str, default='SG_NEG')
...
model = ModelSG_Neg(V, args.embedding_size, unigramsampler, args.negative_num)

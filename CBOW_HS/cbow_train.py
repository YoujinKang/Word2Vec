# from cbow_model import ModelCBOW_HS
from re_model import ModelCBOW_HS
import argparse
...
parser.add_argument('--model', type=str, default='CBOW_HS')
...
log_dir = 'CBOW_HS/train_log/{}_sub{}_window{}_dim{}_{}epoch/'.format(args.model, args.sub_t, args.window_size, args.embedding_size, args.max_epoch)
...
with open(data_path+'HuffmanTree.pkl', 'rb') as fr:
    codeIndex, code_sign = pickle.load(fr)
    fr.close()


model = ModelCBOW_HS(V, args.embedding_size, codeIndex, code_sign)
